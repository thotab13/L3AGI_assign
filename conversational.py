...
class ConversationalAgent(BaseAgent):
    async def run(
        ...
        try:
            ...
            # Create and configure the XAgent-based agent
            agent = xagent_client.create_agent(
                # Add any necessary parameters for creating the agent
            )

            agent_executor = xagent_client.create_agent_executor(agent, tools, verbose=True)
